...
<header id="header">
    ...
    <div class="collapse navbar-collapse  navbar-right navbar-ex1-collapse" id="right">
        <ul class="nav navbar-nav" id="top-right-menubar">
          <li><a href="login_toggleTap.jsp">로그인</a></li>
          <li><a href="joinSelect.jsp">회원가입</a></li>
          <li><a href="myPage.jsp">마이페이지</a></li>	<!-- 로그인 session 유지시 이동하게끔 추후 -->
   ...
   <ul class="nav1">
        ...
        <b style="font-size: 12px; text-align: center;" >카테고리</b>
         <div>
            <div class="nav-column">
               <h3>축산물</h3>
               <ul>
                  <li><a href="productCategory.jsp?code_num=">소고기</a></li>		<!-- 코드분류에 따라 param값으로 이동하게끔 -->
                  <li><a href="productCategory.jsp?">돼지고기</a></li>
                  <li><a href="productCategory.jsp?">닭고기</a></li>
                  <li><a href="productCategory.jsp?">기타</a></li>
               </ul>
            </div>
     ...
     <div id="mainmenu">
        <ul class="nav navbar-nav">
            <li><a href="mainBest.jsp">베스트</a></li>
            <li><a href="mainHotdeal.jsp">핫딜</a></li>
            <li><a href="mainEvent.jsp">이벤트</a></li>
            <li><a href="mainCoupon.jsp">쿠폰</a></li>
