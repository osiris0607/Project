...
<body>
	<div class="container">
		...
		<header id="header">
			<!-- 좌상단 부분 -->
			<div id="left">
				<br> <a id="logo" class="navbar-brand" href="../user/main.jsp"
					style="text-align: center;"><img src="/web/img/logo-b.png"
					width="120px"> </a> <br>
				<br>
				<br>
				<p id="admin">
			...
			<!-- 상단중간 부분 -->
			<div id="center" style="text-align: right;"></div>
			...
			<div
				...
				<br>
				<div id=search>
					<form class="navbar-form navbar-right" name="frm"
						action="../user/productSearch.jsp">
						<div class="form-group" id="searchbar">
							<input type="search" class="form-control" placeholder="검색">
							<button type="submit" class="btn btn-default"
								style="width: 52px; text-align: center; background-color: #9e1030;">
								<img src="/web/img/search.png" width="22px">
							</button>
						</div>
					</form>
				</div>
